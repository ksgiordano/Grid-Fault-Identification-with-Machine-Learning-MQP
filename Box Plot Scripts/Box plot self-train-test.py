...
Freq2 = os.path.join(base_dir2, r".f 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.f_results.csv")
IPMag2 = os.path.join(base_dir2, r".ip_m 1024 Samples 512 Overlap Variable Depth and Trees 3\rf_eversource_1024_.ip_m_results.csv")
IPAngle2 = os.path.join(base_dir2, r".ip_a 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.ip_a_results.csv")
VPMag2 = os.path.join(base_dir2, r".vp_m 1024 Samples 512 Overlap Variable Depth and Trees 3\rf_eversource_1024_.vp_m_results.csv")
VpAngle2 = os.path.join(base_dir2, r".vp_a 1024 Samples 512 Overlap Variable Depth and Trees 2\rf_eversource_1024_.vp_a_results.csv")
...
plt.suptitle("F1 scores of all testing sets with corresponding training sets")
