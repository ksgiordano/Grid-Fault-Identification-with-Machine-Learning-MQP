...
base_dir1 = r"Z:\GESL RF Outputs\Switching"
...
IPMag1 = os.path.join(base_dir1, r".ip_m 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.ip_m_results.csv")
...
VPMag1 = os.path.join(base_dir1, r".vp_m 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.vp_m_results.csv")
VpAngle1 = os.path.join(base_dir1, r".vp_a 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.vp_a_results.csv")

filelocation_arr1 = [Freq1, IPMag1, IPAngle1, VPMag1, VpAngle1]

#GESL OSC usually
base_dir2 = r"Z:\GESL RF Outputs\Switching"
...
plt.suptitle("F1 scores of GESL Switching measurement channels")
