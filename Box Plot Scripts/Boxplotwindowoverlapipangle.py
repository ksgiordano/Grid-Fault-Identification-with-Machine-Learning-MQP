...
Freq1 = os.path.join(base_dir1, r"IP Angle 1024 Samples 512 Overlap Variable Depth and Trees nparray\rf_experiment_results.csv")
IPMag1 = os.path.join(base_dir1, r"IP Angle 512 Samples 256 Overlap Variable Depth and Trees nparray 02-10-2026\rf_eversource_512_IP Angle_results.csv")
IPAngle1 = os.path.join(base_dir1, r"IP Angle 256 Samples 128 Overlap Variable Depth and Trees nparray 02-03-2026\rf_eversource_256_IP Angle_results.csv")
VPMag1 = os.path.join(base_dir1, r"IP Angle 128 Samples 64 Overlap Variable Depth and Trees nparray 02-10-2026\rf_eversource_128_IP Angle_results.csv")
...
Freq2 = os.path.join(base_dir2, r"IP Angle 1024 Samples 256 Overlap Variable Depth and Trees, Item limit=None 02-19-2026\rf_eversource_1024_IP Angle_results.csv")
IPMag2 = os.path.join(base_dir2, r" NEW ONE IP Angle 512 Samples 128 Overlap Variable Depth and Trees\rf_eversource_512_IP Angle_results.csv")
...
Freq3 = os.path.join(base_dir3, r"IP Angle 1024 Samples 768 Overlap Variable Depth and Trees, Item limit=None 02-17-2026\rf_eversource_1024_IP Angle_results.csv")
IPMag3 = os.path.join(base_dir3, r"IP Angle 512 Samples 384 Overlap Variable Depth and Trees, Item limit=None 02-19-2026\rf_eversource_512_IP Angle_results.csv")
...
plt.suptitle("F1 scores of Eversource window sizes, IP Angle, 50%, 25%, 75% Overlap")
