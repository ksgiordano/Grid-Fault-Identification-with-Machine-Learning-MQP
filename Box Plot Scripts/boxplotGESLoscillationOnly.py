...
base_dir1 = r"Z:\GESL RF Outputs\Oscillation"
#ALL OF THESE NEED TO GET CHANGED FOR PLOTTING NEW GRAPH OR IT WILL BE WRONG
Freq1 = os.path.join(base_dir1, r".f 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.f_results.csv")
IPMag1 = os.path.join(base_dir1, r".ip_m 1024 Samples 512 Overlap Variable Depth and Trees 3\rf_eversource_1024_.ip_m_results.csv")
IPAngle1 = os.path.join(base_dir1, r".ip_a 1024 Samples 512 Overlap Variable Depth and Trees\rf_eversource_1024_.ip_a_results.csv")
VPMag1 = os.path.join(base_dir1, r".vp_m 1024 Samples 512 Overlap Variable Depth and Trees 3\rf_eversource_1024_.vp_m_results.csv")
VpAngle1 = os.path.join(base_dir1, r".vp_a 1024 Samples 512 Overlap Variable Depth and Trees 2\rf_eversource_1024_.vp_a_results.csv")

filelocation_arr1 = [Freq1, IPMag1, IPAngle1, VPMag1, VpAngle1]

#GESL OSC usually

base_dir2 = r"Z:\GESL RF Outputs\Oscillation"

Freq2 = os.path.join(base_dir2, r".f 512 Samples 256 Overlap Variable Depth and Trees\rf_eversource_512_.f_results.csv")
IPMag2 = os.path.join(base_dir2, r".ip_m 512 Samples 256 Overlap Variable Depth and Trees\rf_eversource_512_.ip_m_results.csv")
IPAngle2 = os.path.join(base_dir2, r".ip_a 512 Samples 256 Overlap Variable Depth and Trees\rf_eversource_512_.ip_a_results.csv")
VPMag2 = os.path.join(base_dir2, r".vp_m 512 Samples 256 Overlap Variable Depth and Trees\rf_eversource_512_.vp_m_results.csv")
VpAngle2 = os.path.join(base_dir2, r".vp_a 512 Samples 256 Overlap Variable Depth and Trees\rf_eversource_512_.vp_a_results.csv")
...
#colors for medians, default is orange for some reason
...
plt.suptitle("F1 scores of GESL Oscillation measurement channels")
