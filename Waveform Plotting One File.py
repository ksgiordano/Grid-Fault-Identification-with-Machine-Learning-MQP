...
def plot_csv_data(file_path1, x_column, y_column):
    try:
        # Load the dataset
        ...
        plt.title(f'Eversource Raw Data {y_column} vs {x_column}', fontsize=14)
...
plot_csv_data(filepath1, x_column, y_column)